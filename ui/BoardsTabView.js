// BoardsTabView.js - Manages the Boards tab UI
...
class BoardsTabView {
    ...
    createBoardSection(boardName, boardData, assigneeData) {
        const boardHours = (boardData.timeEstimate / 3600).toFixed(1);
    ...
    createAssigneeTable(assigneeData) {
        ...
        boardAssignees.forEach(assigneeName => {
            ...
            const assigneeHours = (assigneeInfo.timeEstimate / 3600).toFixed(1);
