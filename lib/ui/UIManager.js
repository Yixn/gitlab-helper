...
class UIManager {
    constructor() {
        ...
        this.apiView = new ApiTabView(this); // Renamed internally but kept for backwards compatibility
    ...
    createHeader() {
        ...
        this.settingsBtn.onclick = (e) => {
            e.stopPropagation();
            if (this.apiView && this.apiView.labelManager) {
                // Access settings via labelManager since it contains whitelist functionality
                const settingsManager = new SettingsManager(this.apiView);
