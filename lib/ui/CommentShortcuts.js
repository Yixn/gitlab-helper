...
class CommentShortcuts {
    ...
    addCustomShortcut(options) {
        ...
        shortcutContainer.style.minWidth = '185px';
        ...
        shortcutContainer.style.padding = '3px 10px';
        ...
        dropdown.style.paddingRight = '15px';
        ...
        dropdown.style.backgroundPosition = 'right center';
