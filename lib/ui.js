...
function createSummaryContainer() {
    ...
    apiTab.style.padding = '5px 10px';
    apiTab.style.cursor = 'pointer';

    // Helper function to reset all tabs
    function resetAllTabs() {
        ...
        apiTab.style.borderBottom = 'none';
        apiTab.style.fontWeight = 'normal';
    }
    ...
    apiTab.addEventListener('click', function() {
        resetAllTabs();
        switchTab('api');
        apiTab.style.borderBottom = '2px solid #1f75cb';
        apiTab.style.fontWeight = 'bold';
    });

    tabContainer.appendChild(summaryTab);
    tabContainer.appendChild(boardsTab);
    tabContainer.appendChild(historyTab);
    tabContainer.appendChild(apiTab);  // Add the new API tab
    ...
    function switchTab(tabName) {
        ...
        document.getElementById('api-info-content').style.display = 'none';
        ...
        if (tabName === 'summary') {
            ...
            document.getElementById('api-info-content').style.display = 'block';
            // Initialize API info tab
            updateApiInfoTab();
        }
    }
